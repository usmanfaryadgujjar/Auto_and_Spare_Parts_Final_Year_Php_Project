        ...
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card">
	                <button type="button" id="add_admin_button" data-toggle="modal" data-target="#userModal" class="btn btn-info btn-lg">Add New Admin</button>
...
<script>
        ...
        $(document).ready(function(){
           ...
           $(document).on('submit', '#user_form', function(event){
               ...
               if(firstNam != '' && irstNameq != '' && irstNameq !='' && ircnic!='')
               {
                   $.ajax({
                       url:"createadmin-class.php",
                       method:'POST',
           ...
           function getAdmins(){
               $.ajax({
                   url : 'Admin_Data_Class/Get_admin_list.php',
                   method : 'POST',
                   data : {GET_ADMIN:1},
                       ...
                       if (resp.status == 202) {
                           ...
                           $.each(resp.message, function(index, value){
                               ...
                               '<td></td>'+
                                     ...
                                     '<td><a class="btn btn-sm btn-info edit-admin">UPDATE<span style="display:none;">'+JSON.stringify(value)+'</span><i class=" glyphicon glyphicon-pencil"></i></a>&nbsp;<a cid="'+value.id+'" class="btn btn-sm btn-danger delete-seller"><i class=" glyphicon glyphicon-trash">DELETE</i></a></td>'+
                                           '</tr>';
                           });
